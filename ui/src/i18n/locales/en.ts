...
export const en: TranslationMap = {
  ...
  sessionsView: {
    ...
    preflightTokens: "Preflight tokens",
    preflightTranscriptBytes: "Preflight transcript bytes",
    prePromptPrecheck: "Pre-prompt precheck",
    charOverflowGuard: "Char overflow guard",
    midturnPrecheck: "Mid-turn precheck",
